...
const swaggerOptions = {
  definition: {
    ...
    info: {
      title: "Q_ORDER API",
      description:
        "Q_ORDER Backend API Documentation - Multi-Tenant Restaurant Ordering System",
      version: "1.0.0",
    },
    servers: [
      {
    ...
    tags: [
      ...
      },
      {
        ...
        description:
          "Customer assistance and staff assistance request APIs",
      },
      {
        name: "Receipts",
      ...
      {
        name: "Menu Items",
        description: "Menu item APIs",
      },
      {
        name: "Modifier Groups",
        description: "Modifier group APIs",
      },
      {
        name: "Modifier options",
        description: "Modifier option APIs",
      },
      {
        name: "Item Modifier Groups",
        description: "Item modifier group mapping APIs",
      },
    ],
    components: {
      securitySchemes: {
      ...
      schemas: {
        ...
        AssistanceRequest: {
          type: "object",
          required: ["id", "guest_id", "table_id", "type"],
          properties: {
            id: {
              type: "string",
              format: "uuid",
        ...
        AssistanceStatusUpdate: {
          ...
          properties: {
            status: {
              type: "string",
              enum: ["RESOLVED"],
              description: "New status of the assistance request",
            },
          },
        },
        Feedback: {
          type: "object",
          required: ["tenant_id", "branch_id", "order_id", "rating"],
          properties: {
            tenant_id: {
              type: "string",
              example: "TENANT_UUID",
...
swaggerDocument.paths = {
      ...
      requestBody: {
        ...
        content: {
          "application/json": {
            schema: {
              type: "object",
              required: ["phone_number", "message", "receipt_reference"],
              properties: {
                phone_number: {
                  type: "string",
  ...
  "/api/v1/cart": {
    get: {
      ...
      responses: {
        200: {
          description:
            "Shared table draft cart successfully retrieved",
        },
        400: {
  ...
  "/api/v1/cart/items/{cart_item_id}": {
    ...
    delete: {
      ...
      description:
        "Deletes a specific item entry from the table cart.",
      parameters: [
        {
          name: "cart_item_id",
          in: "path",
  ...
  "/api/v1/cart/clear": {
    delete: {
      ...
      description:
        "Removes all items from the active table cart.",
      parameters: [
        {
          $ref: "#/components/parameters/tableIdHeader",
        },
    ...
    patch: {
      ...
      requestBody: {
        ...
        content: {
          "application/json": {
            schema: {
              $ref: "#/components/schemas/AssistanceStatusUpdate",
            },
          },
        },
      },
      ...
      requestBody: {
        ...
        content: {
          "application/json": {
            schema: {
              type: "object",
              required: ["name", "min_selection", "max_selection"],
              properties: {
                name: {
                  type: "string",
                },
